                    ...
                    <div class="carousel-inner" role="listbox">
                        <div>
                            ...
                            <p style="text-align: center;">
                                <strong>
                                    "Cuenta de libre disponibilidad que te permite efectuar depósitos y disponer de tu dinero en cualquier momento."
                                </strong>
                            </p>
                        </div>
                        ...
                        <div class="c_grande"> 
                            <div class="c_peque">
                                ...
                                <ul>
                                    ...
                                    <li>Los depósitos y saldos de las cuentas de ahorros de personas naturales y jurídicas sin fines de lucro se encuentran cubiertos por el Fondo de Seguro de Depósitos hasta el límite de su cobertura.</li>
                                </ul>
                            </div>
                            <div class="c_peque">
                                ...
                                <ul>
                                    ...
                                    <li>Copia de RUC.</li>
                                    <li>Copia de escritura pública de constitución.</li>
                                    <li>Vigencia de poder actualizado de representantes legales (original) no mayor de 30 días de antigüedad.</li>                                                                     
                                </ul>
