            ...
            <header class="slider-main">
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div>
                            <h1 style="color: #ed1843; text-align: center;">¡Conoce más acerca de nuestro servicio!</h1>
                        ...
                        <div class="c_grande"> 
                            <div class="c_peque">
                                ...
                                <ul>
                                    <li>Envía o recibe dinero entre cuentas de distintas entidades financieras a nivel
                                        nacional.</li>
                                    <li>Efectúa tus transferencias desde nuestros canales digitales (Qapaq por
                                        Internet o App Qapaq Móvil), rápido, con total seguridad y desde donde estés.</li>
                                ...
                                <p>(*) Sólo entre entidades participantes en TIN Especial. Sujeto a cambios.</p>
                            </div>
                            <div class="c_peque">
                                ...
                                <ul>
                                    <li>Envío y recepción de transferencias por horarios: Las transferencias realizadas
                                    hasta las 13:30 horas se acreditarán en la cuenta de destino el mismo día. Las
                                    realizadas después de las 13:30 horas se acreditarán al siguiente día útil.</li>
                                    <li>En caso de error de procesamiento la devolución del importe correspondiente
                                    se efectuará en el transcurso de las siguientes 48 horas.</li>
                                    <li>Es responsabilidad del cliente verificar la acreditación de los fondos en caso
                                    de rechazo y devolución.</li>
                                </ul>
                            ...
                            <div class="c_peque">
                                ...
                                <ul>
                                    <li>Estar afiliado a nuestros Canales Digitales (Banca por Internet o APP Móvil).</li>
                                    <li>Código de Cuenta Interbancario (CCI) del beneficiario.</li>
                                    <li>Deberás registrar el nombre completo del beneficiario.</li>
                                </ul>
                            </div>
