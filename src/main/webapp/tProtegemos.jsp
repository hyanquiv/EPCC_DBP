            ...
            <header class="slider-main">
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <img class="c_ima" src="https://www.qapaq.pe/wp-content/uploads/2020/03/teprotegemos-75x75.png" width="54" height="54" alt="beneficios" title="beneficios">                      
                        <div class="c_grande"> 
                            <div class="c_peque2">
                                <h1 style="color: #ed1843; text-align: center;">Cobertura</h1>
                                <p>Seguro que protege tus bienes, mercadería, equipos y maquinarias considerados como base para el otorgamiento de los prestamos menores o iguales a S/. 60,000 cuyo valor total y
                                    ubicación tienen que ser declarados. Los riesgos cubiertos son:</p>
                                <p>Las pérdidas o daños causados por alguna de las siguientes coberturas: Incendio y/o Rayo, Explosión, Terremoto, maremoto, temblor, erupción volcánica, y demás riesgos de la naturaleza,</p>
                                <p>Huelga, motín, conmoción civil, daño malicioso, vandalismo y terrorismo; en todo lo que no esté excluido.</p>
                            </div>                                                  
