                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="c_grandeI"> 
                            ...
                            <div class="otraclase">
                                <p style="text-align: center;"><strong>Hemos puesto a tu disposición el nuevo servicio Pago Link; una plataforma provista por Niubiz (antes Visanet) que permite generar links para pago de cuotas de tus créditos.</strong></p>
                                ...
                                <details open>
                                    ...
                                    <ul>
                                        ...
                                        <li>Cargo con tarjeta de débito afiliada a cualquier cuenta que el cliente mantenga en el sistema financiero (con fondos suficientes para el pago).</li>
                                        <li>No es necesario acercarse a una Agencia, el trámite se realiza en línea.</li>
                                        <li>El pago se procesa y se podrá visualizar en el sistema a las 48 horas de efectuado.</li>
                                    </ul>
                                </details>
                                ...
                                <details >
                                    ...
                                    <ul>
                                        <li>Coordina con tu funcionario de Financiera Qapaq, la generación del Pago Link.</li>
                                        <li>Tu funcionario te remitirá previa coordinación, el link de pago a través de: Correo electrónico, Whatsapp o Redes Sociales. (Según tu elección).</li>
                                        <li>Tu funcionario te remitirá previa coordinación, el link de pago a través de: Correo electrónico, Whatsapp o Redes Sociales. (Según tu elección)</li>

                                    </ul>
                                    <img  src="https://www.qapaq.pe/wp-content/uploads/2020/09/pp.png" width="350" height="300" alt="beneficios" title="beneficios">
                                    <ul>
                                        <li>En la siguiente pantalla deberás ingresar los datos de tu tarjeta de débito (recuerda que sólo podrás colocar cuentas que mantengan fondos disponibles para concretar el pago).</li>
                                    </ul>
                                    <img  src="https://www.qapaq.pe/wp-content/uploads/2020/09/ph.png" width="350" height="300" alt="beneficios" title="beneficios">
                                    <ul>
                                        <li>Efectúas el pago y recibes automáticamente una confirmación y tu constancia.</li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>Tu pago se reflejará en nuestros sistemas, como máximo 48 horas después de efectuado.</li>
                                    </ul>
