                    ...
                    <div class="carousel-inner" role="listbox">
                        <div>
                            ...
                            <p style="text-align: center;">
                                <strong>
                                    "Crédito de libre disponibilidad para utilizarlo en lo que desees: Realiza el viaje soñado, inicia un proyecto, estudia o compra lo que tanto quieres."
                                </strong>
                            </p>
                        </div>
                        ...
                        <div class="c_grande"> 
                            <div class="c_peque">
                                ...
                                <ul>
                                    <li>Desembolso oportuno y rápido.</li>
                                    <li>Créditos pre aprobados desde S/ 1,000 a S/ 8,000.</li>
                                    <li>Plazos según tus necesidades, de 6 a 24 meses para pagar.</li>
                                </ul>
                            </div>
                            <div class="c_peque">
                                ...
                                <ul>
                                    <li>Documentos que acrediten ingresos mensuales: 03 últimas boletas de pago, recibos
                                       por honorarios u otros.</li>
                                    <li>Copia DNI titular.</li>
                                    <li>Recibo de servicios (luz o agua).</li>
                                    <li>Documentos de propiedad o de domicilio (constancia de posesión y/o contrato de
                                       alquiler).</li>
